<h1 align="center">Coding Agent Memory</h1>
...
<p align="center">
  <a href="https://github.com/miniLV/coding-agent-memory/stargazers"><img src="https://img.shields.io/github/stars/miniLV/coding-agent-memory?style=flat-square" alt="GitHub stars" /></a>
  <a href="https://github.com/miniLV/coding-agent-memory/releases/latest"><img src="https://img.shields.io/github/v/release/miniLV/coding-agent-memory?style=flat-square" alt="Latest release" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/github/license/miniLV/coding-agent-memory?style=flat-square" alt="License" /></a>
</p>

<p align="center">
  <a href="https://github.com/miniLV/coding-agent-memory">GitHub</a> ·
...
<p align="center">
  ...
  <a href="https://github.com/miniLV/coding-agent-memory/releases"><strong>查看发布记录</strong></a>
</p>

<p align="center">
  <img src="docs/assets/demo.gif" alt="Coding Agent Memory 演示" width="900" />
</p>
...
```text
帮我安装 [miniLV/coding-agent-memory](https://github.com/miniLV/coding-agent-memory)
```
...
![Coding Agent Memory 架构图](docs/agent-memory-arch-sketch.png)

自进化飞轮：Daily 负责记录，Weekly 负责 lint / 合并 / 晋升，Apply 负责让经验回到未来任务。

![Coding Agent Memory 飞轮图](docs/agent-memory-loop-flywheel.png)
...
这些测试证明确定性的本地流程与来源约束可以复现；它们不把合成案例冒充真实用户 benchmark，也不评估 Agent 对未来工程问题的回答质量。后者正在 [#4](https://github.com/miniLV/coding-agent-memory/issues/4) 中设计，记忆模型仍以 [SCHEMA.md](SCHEMA.md) 为唯一规范。
...
![Coding Agent Memory 本地配置界面](docs/assets/local-config-ui.png)
...
![Coding Agent Memory 整理最近一周](docs/assets/recent-week-config-ui.png)
...
![Coding Agent Memory 在 Codex 中的查询示例](docs/assets/codex-engineering-memory-example.png)
